...
int processString(char *string, int len) {
  Serial.println(" ");
  Serial.print(string);
  ...
  */
  ...
  for (int t=0; t<pos; t++) {   
    ...
    if (bits==16 && segmentBegin2 == 0)  {
         ...
         segmentBegin2=t;
         for (int i=0; i<18-(segmentBegin2-segmentBegin); i++) Serial.print(" ");
         Serial.print("[");
     }      
     ...
     if (bits==24 && segmentBegin3 == 0)  {
         Serial.print("] ");      
         segmentBegin3=t;         
         for (int i=0; i<18-(segmentBegin3-segmentBegin2); i++) Serial.print(" ");  
         Serial.print("[");  
     }   
     ...
     if (bits==32 && segmentBegin4 == 0)  {
         Serial.print("] ");      
         segmentBegin4=t;         
         for (int i=0; i<18-(segmentBegin4-segmentBegin3); i++) Serial.print(" ");    
     }       
  } 
  ...
  //processString(string,len );
             
  //Serial.print(" bits ");
  //Serial.print(bits, DEC); 
  /*
  for (int t=0; t<64-pos; t++) {
    Serial.print(" ");
  }
  */
